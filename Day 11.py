...
def play_function():
  ask_to_play = input("Do you want to play a game of Blackjack? 'y' or 'n': " ).lower()
  if ask_to_play =='y':
    clear()
    print (logo)
    ...
    user_list = [user_card_1, user_card_2]
    computer_list = [comp_card_1, comp_card_2]
    user_total = update_sum(user_list)
    computer_total = update_sum(computer_list)
    ...
    def compare():
      if user_total > computer_total and user_total < 21:
        ...
        print("Win with a blackjack ^_^ Yippeeeeee")
      elif computer_total> user_total and computer_total <=21: 
        print ("You lose :(")
    ...
    def more_cards():
      more_input = input("Type 'y' to get another card, 'n' to pass: ").lower()
      if more_input== 'n':
        print(f"Your final hand: {user_list}, Final Score: ")
        ...
        user_list.append(user_next_card)
        user_total = update_sum(user_list)
